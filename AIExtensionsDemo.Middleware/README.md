...
This project provides a demo of how using middleware to add global behaviour to your application using different AI models. It includes configurations and examples for connecting to local and cloud-based AI services such as Ollama, Azure OpenAI, OpenAI, and GitHub Models.
